...
extern const u16 gFontBWLevelLatinGlyphs[];
extern const u8 gFontBWLevelLatinGlyphWidths[];
extern const u16 gFontWidenumberLatinGlyphs[];
extern const u8 gFontWidenumberLatinGlyphWidths[];
